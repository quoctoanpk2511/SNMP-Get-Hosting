...
public class HrStorageTableService extends AbstractSnmpService{
	
	private static String oid = ".1.3.6.1.2.1.25.2.3";
	
	public HrStorageTableService(String host, String community, Integer version) {
